...
- Required config keys: `mode`, `public_base_url` (`packs/messaging-webchat/schemas/messaging/webchat/public.config.schema.json:30`).
- Config schema reference: `schemas/messaging/webchat/public.config.schema.json` (`packs/messaging-webchat/pack.manifest.json:32`).
...
## PUBLIC_BASE_URL
- Required config key in `packs/messaging-webchat/schemas/messaging/webchat/public.config.schema.json:30`.
