...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_messaging_provider_whatsapp_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_messaging_provider_whatsapp_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:greentic:messaging-provider-whatsapp-core@0.0.1:messaging-provider-whatsapp:encoded world"
)]
#[doc(hidden)]
...
/schema-core-api@1.0.0\x05\x04\x04\0Kgreentic:messaging-provider-whatsapp-core/m\
essaging-provider-whatsapp@0.0.1\x04\0\x0b!\x01\0\x1bmessaging-provider-whatsapp\
