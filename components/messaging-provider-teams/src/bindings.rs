...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_messaging_provider_teams_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_messaging_provider_teams_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:greentic:messaging-provider-teams-core@0.0.1:messaging-provider-teams:encoded world"
)]
#[doc(hidden)]
...
/schema-core-api@1.0.0\x05\x04\x04\0Egreentic:messaging-provider-teams-core/mess\
aging-provider-teams@0.0.1\x04\0\x0b\x1e\x01\0\x18messaging-provider-teams\x03\0\
