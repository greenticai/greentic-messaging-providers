...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_messaging_ingress_whatsapp_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_messaging_ingress_whatsapp_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:greentic:messaging-ingress-whatsapp@0.0.1:messaging-ingress-whatsapp:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 2433] = *b"\
...
ok\x01\x05\x04\0\x1dprovider:common/ingress@0.0.2\x05\x08\x04\0Dgreentic:messagi\
ng-ingress-whatsapp/messaging-ingress-whatsapp@0.0.1\x04\0\x0b\x20\x01\0\x1amess\
aging-ingress-whatsapp\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-co\
