...
/schema-core-api@1.0.0\x05\x04\x04\0Egreentic:messaging-provider-email-core/mess\
aging-provider-email@0.0.1\x04\0\x0b\x1e\x01\0\x18messaging-provider-email\x03\0\
