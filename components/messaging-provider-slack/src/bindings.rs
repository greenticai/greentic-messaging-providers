...
pi@1.0.0\x05\x04\x04\0Egreentic:messaging-provider-slack-core/messaging-provider\
-slack@0.0.1\x04\0\x0b\x1e\x01\0\x18messaging-provider-slack\x03\0\0\0G\x09produ\
