...
fn input_schema() -> SchemaIr {
    schema_obj(
        "slack.schema.input.title", "slack.schema.input.description",
        vec![("message", true, schema_str("slack.schema.input.message.title", "slack.schema.input.message.description"))],
        true,
    )
}
...
fn output_schema() -> SchemaIr {
    schema_obj(
        "slack.schema.output.title", "slack.schema.output.description",
        vec![
            ("ok", true, schema_bool_ir("slack.schema.output.ok.title", "slack.schema.output.ok.description")),
            ("message_id", false, schema_str("slack.schema.output.message_id.title", "slack.schema.output.message_id.description")),
        ],
        true,
    )
}
...
fn config_schema() -> SchemaIr {
    schema_obj(
        "slack.schema.config.title", "slack.schema.config.description",
        vec![
            ("enabled", true, schema_bool_ir("slack.schema.config.enabled.title", "slack.schema.config.enabled.description")),
            ("default_channel", false, schema_str("slack.schema.config.default_channel.title", "slack.schema.config.default_channel.description")),
            ("public_base_url", true, schema_str_fmt("slack.schema.config.public_base_url.title", "slack.schema.config.public_base_url.description", "uri")),
            ("api_base_url", true, schema_str_fmt("slack.schema.config.api_base_url.title", "slack.schema.config.api_base_url.description", "uri")),
            ("bot_token", true, schema_secret("slack.schema.config.bot_token.title", "slack.schema.config.bot_token.description")),
        ],
        false,
    )
}
