...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_messaging_provider_webex_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_messaging_provider_webex_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:greentic:messaging-provider-webex-core@0.0.1:messaging-provider-webex:encoded world"
)]
#[doc(hidden)]
...
/schema-core-api@1.0.0\x05\x04\x04\0Egreentic:messaging-provider-webex-core/mess\
aging-provider-webex@0.0.1\x04\0\x0b\x1e\x01\0\x18messaging-provider-webex\x03\0\
