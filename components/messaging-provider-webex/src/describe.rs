...
pub(crate) const I18N_PAIRS: &[(&str, &str)] = &[
    ...
    ("webex.op.ingest_http.description", "Normalize Webex webhook payload"),
    ("webex.op.render_plan.title", "Render Plan"),
    ("webex.op.render_plan.description", "Render universal message plan"),
    ("webex.op.encode.title", "Encode"),
    ("webex.op.encode.description", "Encode universal payload for Webex"),
    ("webex.op.send_payload.title", "Send Payload"),
    ("webex.op.send_payload.description", "Send encoded payload to Webex API"),
    ("webex.schema.input.title", "Webex input"),
    ("webex.schema.input.description", "Input for Webex run/send operations"),
    ...
    ("webex.schema.output.description", "Result of Webex operation"),
    ("webex.schema.output.ok.title", "Success"),
    ("webex.schema.output.ok.description", "Whether operation succeeded"),
    ("webex.schema.output.message_id.title", "Message ID"),
    ("webex.schema.output.message_id.description", "Webex message identifier"),
    ("webex.schema.config.title", "Webex config"),
    ("webex.schema.config.description", "Webex provider configuration"),
    ("webex.schema.config.enabled.title", "Enabled"),
    ("webex.schema.config.enabled.description", "Enable this provider"),
    ("webex.schema.config.public_base_url.title", "Public base URL"),
    ("webex.schema.config.public_base_url.description", "Public URL for callbacks"),
    ("webex.schema.config.default_room_id.title", "Default room ID"),
    ("webex.schema.config.default_room_id.description", "Room used when destination is omitted"),
    ("webex.schema.config.default_to_person_email.title", "Default person email"),
    ("webex.schema.config.default_to_person_email.description", "Email used when destination is omitted"),
    ("webex.schema.config.api_base_url.title", "API base URL"),
    ("webex.schema.config.api_base_url.description", "Webex API base URL"),
    ("webex.schema.config.bot_token.title", "Bot token"),
    ("webex.schema.config.bot_token.description", "Bot token for Webex API calls"),
    ...
    ("webex.qa.setup.default_to_person_email", "Default person email"),
