...
pub unsafe fn _export_apply_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    let result1 = T::apply(_rt::string_lift(bytes0));
...
pub trait Guest {
    fn apply(plan_json: _rt::String) -> Result<_rt::String, _rt::String>;
}
#[doc(hidden)]
macro_rules! __export_world_provision_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "apply")] unsafe extern "C" fn
        export_apply(arg0 : * mut u8, arg1 : usize,) -> * mut u8 { unsafe {
        $($path_to_types)*:: _export_apply_cabi::<$ty > (arg0, arg1) } } #[unsafe
        (export_name = "cabi_post_apply")] unsafe extern "C" fn _post_return_apply(arg0 :
        * mut u8,) { unsafe { $($path_to_types)*:: __post_return_apply::<$ty > (arg0) } }
        };
    };
}
#[doc(hidden)]
pub(crate) use __export_world_provision_cabi;
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_provision_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_provision_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_provision_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:greentic:component-provision@0.1.0:provision:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1630] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xde\x0b\x01A\x02\x01\
...
\x20greentic:state/state-store@1.0.0\x05\x03\x01j\x01s\x01s\x01@\x01\x09plan-jso\
ns\0\x04\x04\0\x05apply\x01\x05\x04\0,greentic:component-provision/provision@0.1\
.0\x04\0\x0b\x0f\x01\0\x09provision\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
