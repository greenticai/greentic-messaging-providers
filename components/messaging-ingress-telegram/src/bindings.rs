...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_messaging_ingress_telegram_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_messaging_ingress_telegram_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:greentic:messaging-ingress-telegram@0.0.1:messaging-ingress-telegram:encoded world"
)]
#[doc(hidden)]
...
ng-ingress-telegram/messaging-ingress-telegram@0.0.1\x04\0\x0b\x20\x01\0\x1amess\
aging-ingress-telegram\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-co\
